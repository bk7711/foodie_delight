  ...
  document.querySelector(".card-container").innerHTML = `
    ...
    <div class="col s6 m6 l4">
      <div class="card">
        ...
        <a href="${data.hits[0].recipe.shareAs}"><span>${data.hits[0].recipe.label}</span></a>
        </div>
      </div>
    </div>
    ...
    <div class="col s6 m6 l4">
      <div class="card">
        ...
        <div class="card-content">
        <a href="${data.hits[1].recipe.shareAs}"><span>${data.hits[1].recipe.label}</span></a>
        </div>
      </div>
    </div>
    ...
    <div class="col s6 m6 l4">
      <div class="card">
        ...
        <div class="card-content">
        <a href="${data.hits[2].recipe.shareAs}"><span>${data.hits[2].recipe.label}</span></a>
        </div>
      </div>
    </div>
    ...
    <div class="col s6 m6 l4">
      <div class="card">
        ...
        <div class="card-content">
        <a href="${data.hits[7].recipe.shareAs}"><span>${data.hits[7].recipe.label}</span></a>
        </div>
      </div>
    </div>
    ...
    <div class="col s6 m6 l4">
      <div class="card">
        ...
        <div class="card-content">
          <a href="${data.hits[5].recipe.shareAs}"><span>${data.hits[5].recipe.label}</span></a>        
        </div>
      </div>
    </div>
    ...
    <div class="col s6 m6 l4">
      <div class="card">
        ...
        <div class="card-content">
        <a href="${data.hits[6].recipe.shareAs}"><span>${data.hits[6].recipe.label}</span></a>
        </div>
      </div>
    </div>
