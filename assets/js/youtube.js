        ...
        if(response.ok){
            response.json().then(function(data){
                ...
                for(var i = 0; i<videos.length; i++){
                    ...
                    videoEl.innerHTML = `
                    <a href="https://www.youtube.com/watch?v=${videos[i].id.videoId}" target="_blank"><img width="300" height="250" src="${videos[i].snippet.thumbnails.medium.url}" alt="${videos[i].snippet.description}"></a>
